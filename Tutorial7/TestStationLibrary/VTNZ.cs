...
{
    public sealed class VTNZ : TestStation   //Singleton is better sealed   
    {
        private static VTNZ _vtnz;  //static variable (only one instance of VTNZ)
        ...
        private VTNZ() { }  //private contructor

        public static VTNZ GetInstance(string Name, string Address, string Tel, string OpenTime)// static method
        {
            if(_vtnz == null)
            {
